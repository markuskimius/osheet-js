...
class ResizableTable {
    ...
    constructor(table, options={}) {
        this.cursor = new ResizableTableCursor(table, options.dcursor, options.celltype, options.direction);
        this.resizer = new ResizableTableResizer(table, options.allowOverflow, options.celltype, options.direction);
    }
}
...
class ResizableTableCursor {
    ...
    constructor(table, dcursor=null, celltype=null, direction=null) {
        this.dcursor = dcursor ?? this.dcursor;
        this.celltype = celltype ?? this.celltype;
        this.direction = direction ?? this.direction;

        table.querySelectorAll(`:scope > * > tr > ${this.celltype}`).forEach((cell) => {
...
class ResizableTableResizer {
    ...
    constructor(table, allowOverflow=null, celltype=null, direction=null) {
