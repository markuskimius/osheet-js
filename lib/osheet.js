...
export default class OSheet {
    ...
    constructor(table, options={}) {
        this.editor = options.editable ?? new TableEditor(table, options);
        this.resizer = options.resizable ?? new TableResizer(table, options);
...
class TableCursorHandler {
    ...
    constructor(table, options={}) {
        this.dcursor = options.dcursor ?? this.dcursor;
        this.rcelltype = options.rcelltype ?? this.rcelltype;
...
class TableEditor {
    ...
    constructor(table, options={}) {
        this.ecelltype = options.ecelltype ?? this.ecelltype;
